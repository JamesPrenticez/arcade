const TextBlock = () => {
  return (
      <div className="bg-[#210002] h-[100vh]">
          <div className="mx-auto pt-10 max-w-7xl text-green-600">
              <h1 className=" font-bold">Software Developer?</h1>
              <p className="text-[#ffaf1b]">
          ...
          <footer className="text-[#ffaf1b] fixed w-full bottom-0 flex justify-center items-center mb-10">Created With 🧡 By&nbsp;<a className="no-underline text-[#ffaf1b]" href="">James Prentice</a></footer>
      </div>
  );
}
